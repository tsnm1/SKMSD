...
#' An Aggregating version of SKMSD
#'
#' @param W Same as SKMSD;
#' @param class_K
#' @param data_x
#' @param M
#' @param y
...
#' SKMSD method based on the cross-validation case
#'
#' @param W Same as SKMSD;
#' @param class_K
#' @param data_x
...
#' Extension of SKMSD to consider more synthetic data methods.
#'
#' @param W Same as SKMSD;
#' @param class_K
#' @param data_x
...
#' Extension of SKMSD_B to consider more synthetic data methods.
#'
#' @param W Same as SKMSD_B;
#' @param class_K
#' @param data_x
#' @param M
#' @param y
